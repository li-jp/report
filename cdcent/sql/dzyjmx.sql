SELECT D.NAME DEPTNAME, USR.USERNAME USERNAME, DETAIL1.PRICE PRICE, DETAIL1.PROPORTION FC_RATIO, DETAIL1.REASON REASON, FEE.REVIEW_DATE SH_DATE, FEE.FEE_NAME FEE_NAME, FEE.CONTRACT_TYPE CONTRACT_TYPE, MM.CONTRACT_CODE CONTRACT_CODE, DETAIL1.USER_ID USER_ID, DETAIL1.DEPT_ID DEPT_ID,USR.JOB_ID
